...
import { MinuteCandleStick, DailyCandleStick, WeeklyCandleStick } from '../types/candle';
import { getCurrentTicker, getCandlesForMinutes, getCandlesForDaily, getCandlesForWeekly } from './market';
